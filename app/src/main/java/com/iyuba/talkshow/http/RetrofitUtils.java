package com.iyuba.talkshow.http;
...
public class RetrofitUtils {
    ...
    private static synchronized Retrofit getRetrofit(String url) {
        ...
        OkHttpClient ok = RetrofitUrlManager.getInstance().with(new OkHttpClient.Builder()).addInterceptor(interceptor).connectTimeout(50, TimeUnit.SECONDS).build();
