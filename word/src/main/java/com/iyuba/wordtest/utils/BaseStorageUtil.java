...
public class BaseStorageUtil {
    ...
    public static File getInnerDir(Context context) {
        File dirFile = new File(getInnerStorageDir(context).getAbsolutePath());
        if(!dirFile.exists()) dirFile.mkdir();
        return dirFile;
    }
    ...
    public static File getExternalDir(Context context) {
        File dirFile = new File(getExternalStorageDir(context).getAbsolutePath());
        if(!dirFile.exists()) dirFile.mkdir();
        return dirFile;
    }
    ...
    public static File getDir(Context context) {
        return isExistSDCard() ?
                getExternalDir(context) : getInnerDir(context);
    }
