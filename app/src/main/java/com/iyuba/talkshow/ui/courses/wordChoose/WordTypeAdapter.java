...
public class WordTypeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Callback callback;
    Context context;


    public WordTypeAdapter(List<TypeHolder> types) {
        this.types = types;
    }
