...
public class DLNADeviceManager {
    public interface MediaRenderDeviceChangeListener {
        ...
        void onFinished(final List<Device> list);
    }
        ...
        public boolean handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MSG_SEARCH_FINISHED:
                    mListener.onFinished(mDeviceList);
                    return true;
                default:
                    return false;
            }
...
//        return true ;
        Log.d("com.iyuba.talkshow",device.getDeviceType());
        return device != null && !device.getDeviceType().contains("InternetGatewayDevice");
