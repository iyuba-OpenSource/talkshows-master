...
public class SlidingMenuPresenter extends BasePresenter<SlidingMenuMvpView> {
    ...
    @Inject
    public SlidingMenuPresenter(ConfigManager configManager) {
    ...
    private void setDomainShort() {
        ...
        Constant.Url.CHILD_PROTOCOL_BJIYB_PRIVACY = "http://iuserspeech."+ Constant.Web.WEB_SUFFIX.replace("/","")+":9001/api/protocolpriForChildren.jsp?company=1&apptype=";
