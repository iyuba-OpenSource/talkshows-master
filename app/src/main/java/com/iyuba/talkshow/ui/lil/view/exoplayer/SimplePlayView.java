 ...
 * 简单的播放器
 */
public class SimplePlayView extends FrameLayout implements AdViewProvider {
    ...
    private final SimplePlayView.ComponentListener componentListener;
    ...
    @Nullable private final SimplePlayControlView controller;
    ...
    @Nullable private SimplePlayView.ControllerVisibilityListener controllerVisibilityListener;

    @SuppressWarnings("deprecation")
    @Nullable
    private SimplePlayControlView.VisibilityListener legacyControllerVisibilityListener;

    @Nullable private SimplePlayView.FullscreenButtonClickListener fullscreenButtonClickListener;

    private boolean useArtwork;
    @Nullable private Drawable defaultArtwork;
    private @SimplePlayView.ShowBuffering int showBuffering;
    ...
    public SimplePlayView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, /* defStyleAttr= */ 0);
    }

    @SuppressWarnings({"nullness:argument", "nullness:method.invocation"})
    public SimplePlayView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        componentListener = new SimplePlayView.ComponentListener();
        ...
        int controllerShowTimeoutMs = SimplePlayControlView.DEFAULT_SHOW_TIMEOUT_MS;
        ...
        if (contentFrame != null && surfaceType != SURFACE_TYPE_NONE) {
            ...
            // We don't want surfaceView to be clickable separately to the SimplePlayView itself, but we
            // do want to register as an OnClickListener so that surfaceView implementations can propagate
            // click events up to the SimplePlayView by calling their own performClick method.
        ...
        SimplePlayControlView customController = findViewById(R.id.exo_controller);
        View controllerPlaceholder = findViewById(R.id.exo_controller_placeholder);
        if (customController != null) {
            this.controller = customController;
        } else if (controllerPlaceholder != null) {
            // Propagate attrs as playbackAttrs so that SimplePlayControlView's custom attributes are
            // transferred, but standard attributes (e.g. background) are not.
            this.controller = new SimplePlayControlView(context, null, 0, attrs);
    ...
    public static void switchTargetView(
            Player player,
            @Nullable SimplePlayView oldPlayerView,
            @Nullable SimplePlayView newPlayerView) {
     ...
     * {@link #switchTargetView(Player, SimplePlayView, SimplePlayView)} rather than this method.
     ...
     */
    public void setShowBuffering(@SimplePlayView.ShowBuffering int showBuffering) {
    ...
    /**
     * Sets the {@link SimplePlayControlView.VisibilityListener}.
     *
     * <p>Removes any listener set by {@link
     * #setControllerVisibilityListener(SimplePlayControlView.VisibilityListener)}.
     *
     * @param listener The listener to be notified about visibility changes, or null to remove the
     *     current listener.
     */
    @SuppressWarnings("deprecation") // Clearing the legacy listener.
    public void setControllerVisibilityListener(@Nullable SimplePlayView.ControllerVisibilityListener listener) {
        this.controllerVisibilityListener = listener;
        setControllerVisibilityListener((SimplePlayControlView.VisibilityListener) null);
    }
     ...
     *
     * <p>Removes any listener set by {@link
     * #setControllerVisibilityListener(SimplePlayView.ControllerVisibilityListener)}.
     *
     * @deprecated Use {@link #setControllerVisibilityListener(SimplePlayView.ControllerVisibilityListener)} instead.
     */
    @SuppressWarnings("deprecation")
    @Deprecated
    public void setControllerVisibilityListener(
            @Nullable SimplePlayControlView.VisibilityListener listener) {
        Assertions.checkStateNotNull(controller);
        ...
        setControllerVisibilityListener((SimplePlayView.ControllerVisibilityListener) null);
    }

    /**
     * Sets the {@link SimplePlayView.FullscreenButtonClickListener}.
     *
     * <p>Clears any listener set by {@link
     * #setControllerOnFullScreenModeChangedListener(SimplePlayControlView.OnFullScreenModeChangedListener)}.
     *
     ...
     */
    @SuppressWarnings(
            "deprecation") // Calling the deprecated method on SimplePlayControlView for now.
    public void setFullscreenButtonClickListener(@Nullable SimplePlayView.FullscreenButtonClickListener listener) {
        Assertions.checkStateNotNull(controller);
    ...
    /**
     * Sets the {@link SimplePlayControlView.OnFullScreenModeChangedListener}.
     *
     * <p>Clears any listener set by {@link
     * #setFullscreenButtonClickListener(SimplePlayView.FullscreenButtonClickListener)}.
     *
     * @param listener The listener to be notified when the fullscreen button is clicked, or null to
     *     remove the current listener and hide the fullscreen button.
     * @deprecated Use {@link #setFullscreenButtonClickListener(SimplePlayView.FullscreenButtonClickListener)}
     *     instead.
     */
    @Deprecated
    ...
    // Implementing the deprecated SimplePlayControlView.VisibilityListener and
    // SimplePlayControlView.OnFullScreenModeChangedListener for now.
    @SuppressWarnings("deprecation")
    private final class ComponentListener
            implements Player.Listener,
            OnLayoutChangeListener,
            OnClickListener,
            SimplePlayControlView.VisibilityListener,
            SimplePlayControlView.OnFullScreenModeChangedListener {
        ...
        public void onTracksChanged(Tracks tracks) {
            ...
            Player player = checkNotNull(SimplePlayView.this.player);
        ...
        // SimplePlayControlView.VisibilityListener implementation
        ...
        // SimplePlayControlView.OnFullScreenModeChangedListener implementation
