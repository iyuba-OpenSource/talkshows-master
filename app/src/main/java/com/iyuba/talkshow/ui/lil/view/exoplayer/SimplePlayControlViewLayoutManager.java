...
public class SimplePlayControlViewLayoutManager {
    ...
    private final SimplePlayControlView playerControlView;
    ...
    public SimplePlayControlViewLayoutManager(SimplePlayControlView playerControlView) {
    ...
    private void updateLayoutForSizeChange() {
        ...
        if (timeBar != null) {
            ...
            @Nullable ViewGroup.MarginLayoutParams timeBarParams = (ViewGroup.MarginLayoutParams) timeBar.getLayoutParams();
