...
public class DevControlActivity extends BaseActivity implements DevControlMvpView, ControlPointView.OnMediaControlActionListener, SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("com.iyuba.talkshow", Runtime.getRuntime().availableProcessors() + "");
        binding.controlPointView.setOnMediaControlActionListener((devcontrol.ControlPointView.OnMediaControlActionListener) this);
        binding.controlPointView.setOnSeekChangeListener(this);
        binding.controlPointView.setTitle(getIntent().getStringExtra("title"));
        ...
        mController.setPlayMonitor(new IController.PlayerMonitor() {
            ...
            public void onGetMediaDuration(int totalTimeSeconds) {
                binding.controlPointView.setDuration(totalTimeSeconds);
            }

            @Override
            public void onGetMaxVolume(int max) {
                binding.controlPointView.setMaxVolume(max);
...
//                controlPointView.setVolume(current);
            ...
            @Override
            public void onPlay() {
                binding.controlPointView.updatePlayBtnStatus(true);
            }

            @Override
            public void onPause() {
                binding.controlPointView.updatePlayBtnStatus(false);
            }
            ...
            public void onProgressUpdated(int currentTimeSeconds) {
                binding.controlPointView.updateProcess(currentTimeSeconds);
                current_seconds = currentTimeSeconds;
            }
    ...
    protected void onResume() {
        super.onResume();
//        Log.d("com.iyuba.talkshow", "onResume1");
...
//        }
    ...
    public void onPlayBtnClicked() {
        ...
        if (mController.isPaused()) {
            resumePlay(binding.controlPointView.getCurrentDuration());
        } else {
            play(currentUri);
        }
    }
    ...
    public void onNextBtnClicked() {
        mController.seek(mDevice, current_seconds + 5);
    }
