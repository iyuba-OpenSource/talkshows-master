...
public class SlidingMenuFragment extends BaseFragment implements SlidingMenuMvpView {
    ...
    private void initView(){
        ...
        //设置关于的显示
        binding.tvAbout.setText("关于"+getResources().getString(R.string.app_name));
    };
    ...
    private void initClick(){
        ...
        binding.addIyubaGroup.setOnClickListener(v->{
            ...
            if (configManager.getQQOfficial() > 0) {
                ...
                GroupChatManageActivity.start(mContext, 9968, getString(R.string.iyuba_group), true);
            }
        });
        //使用帮助
        ...
        //小视频
//        /*binding.smallVideo.setOnClickListener(v->{
//            if (!UserInfoManager.getInstance().isLogin()) {
//                startToLogin();
//                return;
//            }
...
//        });*/
    ...
    private void setData(){
        ...
        //设置官方群名称
        binding.groupName.setText(getString(R.string.app_name) + getString(R.string.iyuba_group));
        //设置关于的名称
    ...
    //刷新用户信息
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void onLoginEvent(UserRefreshEvent refreshEvent){
        setUserUI();
    }
}
