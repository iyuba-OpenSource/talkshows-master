...
public class HomePresenter extends BasePresenter<HomeMvpView> {
    ...
    @Inject
    public HomePresenter(DataManager dataManager, DLManager dlManager, ConfigManager configManager,
                         AdManager adManager,
                    ...
                    public void onNext(RegisterMobResponse response) {
                        ...
                        if (1 == response.isLogin) {
                            ...
                            if (response.userinfo != null) {
                                UserInfoManager.getInstance().getRemoteUserInfo(response.userinfo.uid(),null);
                            } else {
