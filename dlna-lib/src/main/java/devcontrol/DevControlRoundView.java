...
// */
//public class DevControlRoundView extends View {
...
//
//
//    public DevControlRoundView(Context context) {
//        super(context);
//        init(context, null);
//    }
//
//    public DevControlRoundView(Context context, @Nullable AttributeSet attrs) {
//        super(context, attrs);
//        init(context, attrs);
//    }
//
//    public DevControlRoundView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
